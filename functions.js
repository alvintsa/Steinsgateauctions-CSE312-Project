...
// console.log("http://" + window.location.host + '/websocket')

    // sending a connect request to the server.
const socket = io.connect("http://" + window.location.host, {transports: ['websocket'], allowEIO4: true
});
...
// const socket = io.connect("http://" + window.location.host + '/websocket', {transports: ['websocket']});
...
function welcome() {
    document.getElementById("paragraph").innerHTML += "<br/>Welcome to my image database, but with JavaScript 😀"
